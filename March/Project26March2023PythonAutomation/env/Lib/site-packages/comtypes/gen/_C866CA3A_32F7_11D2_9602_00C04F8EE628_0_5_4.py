...
__all__ = [
    'SpeechAudioFormatGUIDWave', 'DISPID_SVResume',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_LETTERTOSOUND',
    'SPINTERFERENCE_NOSIGNAL', 'SVP_20', 'SRADynamic', 'SVP_17',
    'SpNullPhoneConverter', 'SECFIgnoreWidth', 'DISPID_SBSFormat',
    'DISPID_SGRSTsItem', 'DISPID_SRCEInterference',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRCERecognitionForOtherContext', 'SVF_None',
    'SpeechVoiceCategoryTTSRate',
    'SpeechGrammarTagUnlimitedDictation', 'SVEWordBoundary',
    'ISpeechRecognizerStatus', 'SECFIgnoreCase',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPCPhoneToId',
    'SDA_Two_Trailing_Spaces', 'DISPID_SAStatus', 'UINT_PTR',
    'SPRULESTATE', 'SDKLDefaultLocation', 'SPRS_ACTIVE', 'SVP_19',
    'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE20', 'tagSPPROPERTYINFO',
    'DISPID_SPEDisplayAttributes', 'SVEAllEvents', 'SP_VISEME_18',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGDictationSetState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPPChildren', 'SPSFunction',
    'DISPID_SWFEBitsPerSample', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SDKGetlongValue', 'DISPID_SABufferInfo',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SLPSymbolic',
    'DISPID_SPAStartElementInResult', 'SP_VISEME_10', 'SpMMAudioIn',
    'DISPID_SPRuleNumberOfElements', 'eLEXTYPE_PRIVATE13',
    'SpeechTokenContext', 'ISpLexicon', 'DISPID_SPPNumberOfElements',
    'SVSFIsXML', 'DISPID_SVEVoiceChange', 'DISPID_SRIsShared',
    'SPGS_DISABLED', 'DISPID_SRSClsidEngine',
    'DISPID_SRIsUISupported', 'SVP_0', 'SVP_10', 'ISpeechAudioStatus',
    'IInternetSecurityManager', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SDKEnumKeys', 'SpeechAllElements', 'SP_VISEME_8',
    'DISPID_SPPParent', 'SPBO_NONE', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechPhoneConverter',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSADeviceId',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCVoice',
    'DISPID_SRCERecognition', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseElements', 'SpeechRegistryLocalMachineRoot',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREAudioLevel', 'SPVPRI_OVER',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechRecognizer',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCState',
    'SPSNoun', 'DISPID_SPEPronunciation', 'SAFT11kHz16BitStereo',
    'ISpeechObjectTokens', 'ISpeechDataKey', 'SVSFParseAutodetect',
    'SLTUser', 'DISPID_SLPType', 'SpeechRegistryUserRoot',
    'SpeechVisemeFeature', 'SGRSTTEpsilon',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpObjectTokenCategory', 'SECFDefault',
    'DISPID_SPEAudioTimeOffset', 'SAFT48kHz16BitMono',
    'ISpeechRecoContext', 'ISpeechRecoResult',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFTGSM610_44kHzMono',
    'SpWaveFormatEx', 'DISPID_SVSpeak', 'SAFTNonStandardFormat',
    'SP_VISEME_21', 'SRADefaultToActive', 'SPWORDLIST', 'SGRSTTRule',
    'SpeechTokenIdUserLexicon', 'DISPID_SPCIdToPhone',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE10', 'SPEVENTENUM',
    'DISPID_SpeechXMLRecoResult', 'SPFM_NUM_MODES',
    'SAFT24kHz8BitStereo', 'SpeechGrammarTagDictation',
    'SPVPRI_NORMAL', 'DISPID_SVSLastBookmark', 'DISPID_SVGetProfiles',
    'SGDSActiveWithAutoPause', 'DISPID_SPPs_NewEnum',
    'ISpRecoContext2', 'SPAUDIOSTATE',
    'DISPID_SRCEPropertyNumberChange', 'SRSInactiveWithPurge',
    'ISpRecoContext', 'SASClosed', 'DISPID_SRState', 'DISPID_SPPId',
    'SAFT24kHz16BitMono', 'STCInprocHandler', 'SpeechDiscardType',
    'DISPID_SpeechAudioBufferInfo', 'SAFTADPCM_11kHzMono',
    'SRATopLevel', 'LONG_PTR', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSTPropertyValue', 'SVP_4', 'DISPID_SpeechObjectTokens',
    'DISPID_SpeechPhraseElement', 'SRSInactive', 'DISPID_SVEBookmark',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRSCurrentStreamPosition',
    'SPSERIALIZEDPHRASE', 'DISPID_SPRuleEngineConfidence',
    'SDTAlternates', 'ISpeechLexiconPronunciation',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTsCount',
    'SPXMLRESULTOPTIONS', 'SVP_11', 'SPPS_Unknown',
    'DISPID_SpeechAudio', 'SPDKL_DefaultLocation', 'SPWF_SRENGINE',
    'SPINTERFERENCE_NONE', 'DISPID_SRCEEndStream',
    'SpCompressedLexicon', 'SDTRule', 'SP_VISEME_0',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPCLangId',
    'DISPID_SRCEventInterests', 'DISPID_SVAlertBoundary', 'SRTReSent',
    'Speech_StreamPos_Asap', 'SAFT22kHz8BitMono',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT8kHz8BitMono',
    'SPGS_ENABLED', 'SSTTWildcard', 'DISPID_SPPName',
    'DISPID_SABIBufferSize', 'SPEI_PROPERTY_NUM_CHANGE', 'SBOPause',
    'SPPS_Noun', 'eLEXTYPE_RESERVED10', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPEI_SR_PRIVATE', 'DISPID_SVAudioOutput',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRERequestUI',
    'DISPIDSPTSI_SelectionOffset', 'ISpResourceManager',
    'SP_VISEME_13', 'SpeechVisemeType', 'SVP_18',
    'SpeechPropertyAdaptationOn', 'SAFT48kHz8BitMono',
    'DISPID_SpeechLexiconPronunciation', 'SPPHRASE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SGRSTransitions',
    'DISPID_SRRSpeakAudio', 'DISPID_SRGRules', 'DISPID_SGRAddState',
    'SPCT_SUB_COMMAND', 'SpeechTokenValueCLSID',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechVoiceEvent', 'SVP_3', 'ISpPhraseAlt',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPRuleConfidence', 'SRTStandard',
    'DISPID_SpeechPhraseProperty', 'ISpVoice', 'SREInterference',
    'DISPID_SPIEngineId', 'SPEI_RECO_OTHER_CONTEXT', 'SPAR_Unknown',
    'SPEI_FALSE_RECOGNITION', 'SPINTERFERENCE_NOISE',
    'DISPID_SRGetFormat', 'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_USER',
    'SPSHT_OTHER', 'SPRULE', 'SPEI_MAX_SR',
    'DISPID_SGRsCommitAndSave', 'SSFMOpenForRead',
    'DISPID_SVEEnginePrivate', 'DISPID_SRCBookmark',
    'ISpeechTextSelectionInformation', 'SGRSTTWord',
    'DISPID_SRRTStreamTime', 'DISPID_SRCEFalseRecognition', 'SVP_7',
    'SPBO_TIME_UNITS', 'SPWORDPRONUNCIATIONLIST',
    'SpeechCategoryAudioOut', 'DISPID_SRCSetAdaptationData',
    'SAFT48kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_PRIVATE19', 'SGSDisabled', 'SpeechCategoryRecoProfiles',
    'DISPID_SPARecoResult', 'DISPID_SMSAMMHandle',
    'DISPID_SMSSetData', 'DISPID_SPIAudioSizeTime',
    'SSSPTRelativeToStart', 'DISPID_SASetState', 'SPWT_LEXICAL',
    'SpeechAudioState', 'SVSFPurgeBeforeSpeak', 'SP_VISEME_6',
    'SREAdaptation', 'SVSFPersistXML', 'ISpPhrase',
    'SAFTExtendedAudioFormat', 'DISPID_SRAudioInputStream',
    'SSSPTRelativeToEnd', 'SP_VISEME_16', 'SpNotifyTranslator',
    'SPPS_LMA', 'DISPID_SOTCEnumerateTokens',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechCustomStream',
    'DISPID_SGRSTPropertyId', 'DISPID_SPIReplacements', 'SAFTDefault',
    'SPAO_NONE', 'SAFTGSM610_11kHzMono', 'ISpAudio', 'ISpShortcut',
    'SVSFIsNotXML', 'ISpEventSink', 'SPEI_RESERVED2',
    'SpeechRuleState', 'SPCT_SUB_DICTATION', 'ISpRecognizer3',
    'DISPID_SRRecognizer', 'ISpNotifySource',
    'DISPID_SVGetAudioInputs', 'DISPID_SRSetPropertyNumber',
    'SAFT48kHz8BitStereo', 'Speech_Max_Pron_Length',
    'SPSERIALIZEDRESULT', 'SPTEXTSELECTIONINFO',
    'DISPID_SOTs_NewEnum', 'SVP_14', 'SAFT12kHz8BitMono', 'SVP_16',
    'SPCT_DICTATION', 'SVSFUnusedFlags', 'DISPID_SRCEPhraseStart',
    'ISpeechFileStream', 'SPEI_MAX_TTS', 'STSF_FlagCreate',
    'SVSFVoiceMask', 'ISpeechVoiceStatus',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPBOOKMARKOPTIONS',
    'DISPID_SPRulesItem', 'SpeechRecoContextState',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SGRSTTDictation',
    'DISPID_SpeechLexicon', 'SPPS_RESERVED4', 'SpUnCompressedLexicon',
    'SGRSTTTextBuffer', 'ISpeechPhraseRule', 'ISpeechVoice',
    'SGDSActive', 'SASRun', 'DISPID_SVEStreamStart',
    'DISPID_SRCESoundStart', 'SPSNotOverriden', 'SpeechGrammarState',
    'DISPID_SDKSetBinaryValue', 'SPAUDIOSTATUS', 'eWORDTYPE_ADDED',
    'DISPID_SVPause', 'ISpeechWaveFormatEx', 'SRTSMLTimeout',
    'Speech_Max_Word_Length', 'SPEI_RESERVED3', 'SWTDeleted',
    'DISPID_SGRSTRule', 'DISPID_SOTGetDescription',
    'SpeechAddRemoveWord', 'SPPS_Function', 'SVSFlagsAsync',
    'SAFTADPCM_44kHzStereo', 'SREPropertyStringChange',
    'DISPID_SGRAttributes', 'SWTAdded', 'ISpeechPhraseInfoBuilder',
    'ISpeechRecoResultTimes', 'DISPID_SRRSetTextFeedback',
    'SP_VISEME_4', 'SAFT11kHz8BitMono', 'DISPID_SGRSTNextState',
    'DISPID_SpeechRecoResult2', 'SpeechEngineConfidence',
    'DISPID_SPAsCount', 'DISPID_SADefaultFormat',
    'eLEXTYPE_PRIVATE16', 'SVP_13', 'ISpRecoCategory',
    'eLEXTYPE_PRIVATE17', 'DISPID_SVGetAudioOutputs', 'SPBO_AHEAD',
    'ISpStream', 'DISPID_SPPFirstElement', 'SVP_1', 'SRAImport',
    'DISPID_SOTCSetId', 'SDKLLocalMachine', 'SITooQuiet',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRAlternates',
    'SDA_No_Trailing_Space', 'SAFT16kHz16BitMono',
    'SPAUDIOBUFFERINFO', 'SSTTDictation',
    'ISpeechLexiconPronunciations', 'DISPID_SGRs_NewEnum',
    'DISPID_SVSPhonemeId', 'SpeechRecoProfileProperties',
    'eLEXTYPE_RESERVED4', 'DISPID_SGRName', 'SGDSActiveUserDelimited',
    'SREStreamStart', 'DISPID_SpeechPhraseProperties',
    'DISPID_SVVolume', 'DISPID_SLWWord', 'DISPID_SRCEAudioLevel',
    'ISpNotifyTranslator', 'SpeechTokenKeyFiles',
    'SpeechGrammarTagWildcard', 'SECHighConfidence', 'SPGS_EXCLUSIVE',
    'SAFTCCITT_uLaw_22kHzStereo', 'SDKLCurrentConfig',
    'ISpeechPhraseElement', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SDKGetBinaryValue', 'SpeechInterference',
    'SpeechWordType', 'SPPS_Noncontent', 'SpeechVoiceSpeakFlags',
    'SPWORDPRONOUNCEABLE', 'SAFTNoAssignedFormat',
    'SpResourceManager', 'SPEI_INTERFERENCE',
    'DISPID_SRGCmdSetRuleState', 'IEnumString',
    'DISPID_SGRAddResource', 'SPEI_PHONEME', 'SPEI_TTS_AUDIO_LEVEL',
    'SITooSlow', 'DISPID_SpeechGrammarRule', 'SPCS_ENABLED',
    'SPEI_SR_AUDIO_LEVEL', 'SDTPronunciation', 'DISPID_SRRTLength',
    'SPFM_OPEN_READONLY', 'SpObjectToken', 'SPAUDIOOPTIONS',
    'SPWT_DISPLAY', 'DISPID_SOTDisplayUI', 'SAFT12kHz16BitMono',
    'SPXRO_Alternates_SML', 'DISPID_SVESentenceBoundary',
    'DISPID_SLGetPronunciations', 'ISpStreamFormat', 'tagSTATSTG',
    'ISpProperties', 'DISPID_SRDisplayUI', 'ISpRecognizer2',
    'DISPID_SRRTimes', 'DISPID_SVEAudioLevel', 'DISPID_SRGState',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechLexiconProns',
    'SPEI_SR_BOOKMARK', 'DISPID_SPELexicalForm', 'SREStateChange',
    'IEnumSpObjectTokens', 'SPAS_STOP', 'SVP_21',
    'DISPID_SGRInitialState', 'SPEI_MIN_SR',
    'DISPID_SpeechMMSysAudio', 'SINoise', 'DISPID_SLGetWords',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPPConfidence', 'SpStream', 'SAFT22kHz16BitStereo',
    'DISPID_SVSVisemeId', 'SGLexicalNoSpecialChars',
    'DISPID_SGRSAddSpecialTransition', 'SPFM_CREATE', 'SP_VISEME_9',
    'STSF_CommonAppData', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SOTSetId',
    'SpeechWordPronounceable', 'SPLOADOPTIONS',
    'DISPID_SGRSAddWordTransition', 'SpPhraseInfoBuilder',
    'SPPS_RESERVED2', 'SPAR_High', 'DISPID_SpeechLexiconWords',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPPsItem',
    'SpeechRecognitionType', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SRCRetainedAudio', 'SVSFParseSsml', 'SRTAutopause',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPILanguageId',
    'DISPID_SRGetPropertyNumber', 'SAFTADPCM_11kHzStereo',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRGReset', 'DISPID_SOTId', 'DISPID_SRCERequestUI',
    'DISPID_SPPsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eWORDTYPE_DELETED', 'SPAS_PAUSE', 'SPPS_Interjection',
    'SAFTADPCM_8kHzMono', 'ISpeechPhraseReplacement',
    'DISPID_SRCESoundEnd', 'DISPIDSPRG', 'DISPID_SVRate', 'SINone',
    'SAFT8kHz8BitStereo', 'ISpeechGrammarRule', 'SGDSInactive',
    'SRARoot', 'SAFT32kHz8BitStereo', 'SRERecognition', 'SDTAll',
    'DISPID_SpeechPhraseRule', 'DISPID_SLWPronunciations',
    'DISPID_SOTCDefault', 'SPEI_SOUND_END',
    'DISPID_SVSInputWordPosition', 'SpeechCategoryPhoneConverters',
    'DISPID_SRCreateRecoContext', 'DISPID_SGRsDynamic',
    'STCInprocServer', 'DISPID_SDKCreateKey', 'SP_VISEME_14',
    'SpLexicon', 'SPEI_RESERVED5', 'SPAS_RUN',
    'DISPID_SPEAudioSizeBytes', 'SpeechRuleAttributes', 'SGDisplay',
    'STSF_LocalAppData', 'DISPID_SVEStreamEnd', 'DISPID_SPACommit',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechObjectTokenCategory',
    'SPSHORTCUTTYPE', 'SREHypothesis', 'ISpeechGrammarRuleState',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCRequestedUIType',
    'DISPID_SPAPhraseInfo', 'DISPID_SABufferNotifySize',
    'DISPID_SRRSaveToMemory', 'ISpEventSource', 'SPCONTEXTSTATE',
    'SRCS_Disabled', 'SRTExtendableParse', 'SRAORetainAudio',
    'DISPID_SRCEEnginePrivate', 'SECLowConfidence', 'SGSExclusive',
    'DISPID_SPRuleFirstElement', 'SPEI_START_INPUT_STREAM',
    'DISPID_SBSWrite', 'DISPID_SFSClose', 'ISpMMSysAudio',
    'DISPID_SOTDataKey', 'DISPID_SDKDeleteValue',
    'SVESentenceBoundary', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechAudioStatus', 'SpCustomStream',
    'SpTextSelectionInformation', 'DISPID_SpeechMemoryStream',
    'DISPID_SRCPause', 'DISPID_SpeechDataKey', 'eLEXTYPE_PRIVATE8',
    'SPEVENTSOURCEINFO', 'DISPID_SASFreeBufferSpace', 'SVEViseme',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRAudioInput', 'SpVoice',
    'DISPID_SpeechGrammarRules', 'SpeechRunState',
    'SpSharedRecoContext', 'DISPID_SGRsCommit', 'SPDATAKEYLOCATION',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE6', 'SVF_Stressed',
    'SDTReplacement', 'STSF_AppData', 'eLEXTYPE_PRIVATE3',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'SVEBookmark', 'SAFTGSM610_8kHzMono', 'SpeechAudioFormatType',
    'SAFT16kHz16BitStereo', 'DISPID_SPEs_NewEnum', 'SPPROPERTYINFO',
    'SPLO_STATIC', 'DISPID_SRCAudioInInterferenceStatus', 'SLOStatic',
    'DISPID_SGRSRule', 'ISpeechMemoryStream', 'DISPID_SRSAudioStatus',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVSRunningState',
    'DISPID_SOTCategory', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPIRetainedSizeBytes',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SWFEFormatTag',
    'SREAllEvents', 'SPSHT_EMAIL', 'SFTSREngine',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SLPPhoneIds',
    'ISpeechPhraseProperties', 'SVPNormal', 'eLEXTYPE_PRIVATE18',
    'SVSFNLPMask', 'SINoSignal', 'SRTEmulated', 'SPRS_INACTIVE',
    'SVEPhoneme', 'DISPID_SOTCId', 'DISPID_SWFEExtraData',
    'DISPID_SDKEnumValues', 'SP_VISEME_17',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SAEventHandle',
    'ISpeechPhraseAlternate', 'SPFM_CREATE_ALWAYS',
    'DISPID_SOTGetAttribute', 'SVP_5', 'Speech_StreamPos_RealTime',
    'DISPID_SLGenerationId', 'ISpRecoGrammar',
    'SpeechTokenKeyAttributes', 'DISPID_SOTRemove', 'IStream',
    'DISPID_SGRSTs_NewEnum', 'ISpeechPhraseProperty',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SMSALineId', 'SBONone',
    'SPPS_RESERVED1', 'SDA_One_Trailing_Space',
    'DISPID_SDKSetLongValue', 'SpeechGrammarWordType', 'SPVPRI_ALERT',
    'SPSLMA', 'SpPhoneticAlphabetConverter', 'SPCATEGORYTYPE',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE5',
    'SWPKnownWordPronounceable', 'SpeechPartOfSpeech',
    'DISPID_SAVolume', 'DISPID_SVSLastBookmarkId', 'SVP_8',
    'SVEAudioLevel', 'SPFILEMODE', 'DISPID_SPISaveToMemory',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SOTMatchesAttributes',
    'ISpeechCustomStream', 'DISPID_SRRTOffsetFromStart',
    'SREPhraseStart', 'SVP_12', 'DISPID_SASNonBlockingIO',
    'SpeechEngineProperties', 'SPXRO_SML', 'DISPID_SPRuleId',
    'DISPID_SDKDeleteKey',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SRAONone',
    'SPRECOCONTEXTSTATUS', 'SpeechDisplayAttributes',
    'DISPID_SFSOpen', 'DISPID_SRCCreateResultFromMemory',
    'ISpPhoneConverter', 'SAFT8kHz16BitStereo',
    'DISPID_SRCEHypothesis', 'SPINTERFERENCE', 'SFTInput',
    'SpMemoryStream', 'SECNormalConfidence', 'SPFM_OPEN_READWRITE',
    'SPSHORTCUTPAIR', 'DISPID_SGRsFindRule',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFT24kHz8BitMono',
    'DISPID_SpeechAudioFormat', 'DISPID_SRGDictationLoad',
    'DISPID_SGRClear', 'SRCS_Enabled', 'SpeechDataKeyLocation',
    'SpInProcRecoContext', 'eLEXTYPE_RESERVED7',
    'DISPID_SPEActualConfidence', 'SPDKL_CurrentConfig',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_APP', 'SRESoundStart',
    'SPINTERFERENCE_TOOFAST', 'SPEI_RECOGNITION', 'DISPID_SBSSeek',
    'SPSMF_UPS', 'DISPID_SPRsItem', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPPValue', 'SAFTText', 'SAFT44kHz8BitStereo',
    'DISPID_SLAddPronunciation', 'eLEXTYPE_RESERVED8',
    'SWPUnknownWordUnpronounceable', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechRecoContext', 'SPEI_VISEME', 'DISPID_SLPs_NewEnum',
    'SP_VISEME_12', 'SPCT_COMMAND', 'SAFT44kHz16BitStereo',
    'DISPID_SAFGuid', 'SPSInterjection', 'SVEStartInputStream',
    'SpeechPropertyHighConfidenceThreshold', 'SRSEDone',
    'SAFT11kHz16BitMono', 'SPEI_REQUEST_UI', 'SPEI_UNDEFINED',
    'DISPID_SVAudioOutputStream', 'SECFIgnoreKanaType',
    'STCLocalServer', 'ISpNotifySink', 'DISPID_SLPsItem',
    'DISPID_SCSBaseStream', 'DISPID_SPEEngineConfidence',
    'DISPID_SLWsCount', 'SVEEndInputStream',
    'DISPID_SRGCmdLoadFromObject', 'ISpSerializeState',
    'DISPID_SRCEPropertyStringChange', 'SPLEXICONTYPE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCRetainedAudioFormat',
    'SPAO_RETAIN_AUDIO', 'SDKLCurrentUser',
    'ISpPhoneticAlphabetSelection', 'DISPID_SWFEChannels',
    'DISPID_SRRAudioFormat', 'SPRST_NUM_STATES',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechPhraseReplacements', 'DISPID_SLPsCount',
    'SpeechStreamSeekPositionType', 'SAFT8kHz16BitMono',
    'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE12',
    'SpeechBookmarkOptions', 'SpeechCategoryRecognizers',
    'DISPID_SVVoice', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_PRIVATE9',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRsCount', 'STCRemoteServer',
    'DISPID_SPIEnginePrivateData', 'ISpeechLexiconWords',
    'SpeechPropertyNormalConfidenceThreshold',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPAs_NewEnum', 'SSFMCreate',
    'SPEI_HYPOTHESIS', 'ISpeechXMLRecoResult',
    'DISPID_SLPPartOfSpeech', 'SAFT12kHz16BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRId', 'ISequentialStream',
    'SAFT22kHz8BitStereo', 'SpStreamFormatConverter', 'SLODynamic',
    'SPEI_END_INPUT_STREAM', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVEViseme', 'SpeechLoadOption', 'DISPID_SPIGetText',
    'SpInprocRecognizer', 'ISpeechMMSysAudio', 'SPWT_PRONUNCIATION',
    'DISPID_SGRSTType', 'DISPID_SVSCurrentStreamNumber', 'STCAll',
    'DISPID_SGRsAdd', 'SPSUnknown',
    'SpeechPropertyComplexResponseSpeed', 'SVSFParseMask',
    'SPEI_RESERVED6', 'ISpeechBaseStream', 'ISpeechObjectToken',
    'SpMMAudioOut', 'DISPID_SRCResume', 'SRAExport',
    'SECFEmulateResult', 'SVP_2', 'SGRSTTWildcard', 'DISPIDSPTSI',
    'DISPID_SpeechPhraseAlternates', 'SVSFParseSapi',
    'DISPID_SPRuleName', 'DISPID_SDKGetStringValue', 'SPRST_INACTIVE',
    'SpeechTokenShellFolder', 'IInternetSecurityMgrSite',
    'DISPID_SpeechVoice', 'DISPID_SPIRule', 'DISPID_SVSLastResult',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPRText',
    'SSFMCreateForWrite', 'DISPID_SpeechPhraseReplacement',
    'ISpRecoResult', 'SPRECOGNIZERSTATUS', 'SAFTADPCM_22kHzMono',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRCCreateGrammar', 'SPAS_CLOSED',
    '_ISpeechRecoContextEvents', 'SREBookmark', 'SGSEnabled',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTIsUISupported', 'SVPOver',
    'DISPID_SGRSTText', 'SPSEMANTICFORMAT', 'SVF_Emphasis',
    'SPCT_SLEEP', 'SP_VISEME_3', 'ISpeechLexicon',
    'SPEI_VOICE_CHANGE', 'SREFalseRecognition',
    'DISPID_SRRRecoContext', 'SAFTCCITT_ALaw_22kHzMono', 'SVEPrivate',
    'DISPID_SASState', 'DISPID_SRCEStartStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechPhraseElements',
    'SLTApp', 'SDTAudio', 'DISPID_SpeechPhraseRules',
    'DISPID_SGRSTWeight', 'ISpeechRecoResult2', 'SpSharedRecognizer',
    'SPWORD', 'SP_VISEME_20', 'DISPID_SpeechVoiceStatus',
    'SpeechLexiconType', 'SPDKL_CurrentUser', 'SVP_6',
    'SpeechDictationTopicSpelling', 'ISpObjectToken',
    'DISPID_SGRsItem', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SASPause', 'DISPID_SVStatus', 'SAFT24kHz16BitStereo',
    'SPSSuppressWord', 'SVEVoiceChange', 'SpeechAudioVolume',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRCEBookmark',
    'DISPID_SDKOpenKey', 'DISPID_SPEDisplayText', 'SPSHT_Unknown',
    'DISPID_SLPLangId', 'SPSMF_SAPI_PROPERTIES', 'SpAudioFormat',
    'Speech_Default_Weight', 'SPPHRASEPROPERTY',
    'ISpeechAudioBufferInfo', 'SAFT16kHz8BitStereo',
    'DISPID_SRGetPropertyString', 'DISPID_SVWaitUntilDone',
    'SPPS_NotOverriden', 'DISPID_SVPriority',
    'SWPUnknownWordPronounceable', 'SpeechUserTraining',
    'DISPID_SLWsItem', 'SAFT44kHz8BitMono', 'ISpObjectTokenCategory',
    'eLEXTYPE_PRIVATE7', 'SPAR_Low', 'DISPID_SPRuleChildren',
    'ISpeechRecoResultDispatch', 'WAVEFORMATEX',
    'DISPID_SPRules_NewEnum', 'DISPID_SPRsCount',
    'DISPID_SRSetPropertyString', 'SPRECOSTATE',
    'DISPID_SRCEAdaptation', 'SPRECORESULTTIMES',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechPhraseInfo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVSInputSentencePosition', 'SPEI_PROPERTY_STRING_CHANGE',
    '__MIDL_IWinTypes_0009', 'DISPID_SVGetVoices',
    'SRERecoOtherContext', 'SPPHRASEELEMENT',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE15', 'SDTDisplayText', 'DISPID_SPIElements',
    'eLEXTYPE_MORPHOLOGY', '_ISpeechVoiceEvents',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechPhraseBuilder', 'SpeechCategoryAppLexicons',
    'SpPhoneConverter', 'SRAInterpreter', 'DISPID_SRGetRecognizers',
    'SRSActiveAlways', 'SREPropertyNumChange', 'SP_VISEME_7',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVEPhoneme',
    'DISPID_SREmulateRecognition', 'SpeechCategoryVoices',
    'SPPS_Modifier', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGDictationUnload', 'SPEI_PHRASE_START',
    'SPEI_START_SR_STREAM', 'SECFNoSpecialChars', 'SRESoundEnd',
    'SpeechRecoEvents', 'SAFT22kHz16BitMono',
    'SpeechEmulationCompareFlags', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRRPhraseInfo',
    'DISPID_SPRFirstElement', 'ISpeechLexiconWord', 'SPLO_DYNAMIC',
    'ISpXMLRecoResult', 'eLEXTYPE_RESERVED6',
    'SpeechSpecialTransitionType', 'SpeechMicTraining', 'SPWF_INPUT',
    'SPWAVEFORMATTYPE', 'SP_VISEME_5', 'DISPID_SpeechFileStream',
    'SGLexical', 'SPGRAMMARWORDTYPE', 'DISPID_SDKSetStringValue',
    'DISPID_SGRSTsCount', 'DISPID_SRGSetTextSelection',
    'ISpStreamFormatConverter', 'SASStop',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechObjectTokenCategory',
    'SPEI_ADAPTATION', 'DISPID_SVDisplayUI', 'SpeechVoicePriority',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVSpeakStream', 'ISpeechAudio',
    'SSFMOpenReadWrite', 'DISPID_SpeechBaseStream',
    'DISPID_SRRTTickCount', 'SpeechCategoryAudioIn', 'SPPS_RESERVED3',
    'eLEXTYPE_PRIVATE2', 'SpeechAudioProperties',
    'SAFT44kHz16BitMono', 'SPAR_Medium', 'SVPAlert',
    'DISPID_SPEsItem', 'SGPronounciation',
    'SpeechRetainedAudioOptions', 'SPGRAMMARSTATE',
    'SPSHT_NotOverriden', 'SPRST_ACTIVE', 'DISPID_SRStatus',
    'ISpObjectWithToken', 'SVSFIsFilename', 'SP_VISEME_11',
    'SRSEIsSpeaking', 'SRSActive', 'DISPID_SASCurrentDevicePosition',
    'SPEI_WORD_BOUNDARY', 'SAFTADPCM_22kHzStereo', 'SPEI_RESERVED1',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechRecoResult',
    'DISPID_SLGetGenerationChange', 'DISPID_SPERequiredConfidence',
    'SPPS_Verb', 'DISPID_SPRulesCount', 'SPPARTOFSPEECH',
    'eLEXTYPE_PRIVATE11', 'ISpeechGrammarRules',
    'DISPID_SpeechLexiconWord', '_RemotableHandle',
    'SPEI_SENTENCE_BOUNDARY', 'SREPrivate', 'SPSVerb', 'SPBO_PAUSE',
    'SpeechTokenKeyUI', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpDataKey', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRRGetXMLResult', 'SPWORDTYPE', 'SpeechVoiceEvents',
    'SVSFDefault', 'DISPID_SPEAudioSizeTime', 'DISPID_SPIGrammarId',
    'DISPID_SRGId', 'DISPID_SOTGetStorageFileName',
    'SPWORDPRONUNCIATION', 'SAFT32kHz16BitMono',
    'DISPID_SpeechPhraseAlternate', 'SAFT12kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVEventInterests',
    'SITooFast', 'DISPIDSPTSI_ActiveOffset', 'SPBINARYGRAMMAR',
    'DISPID_SOTCGetDataKey', 'SpeechFormatType', 'SPSModifier',
    'DISPID_SRCRecognizer', 'SpeechVoiceSkipTypeSentence',
    'SSTTTextBuffer', 'SVP_15', 'DISPID_SGRSTPropertyName',
    'SPEI_MIN_TTS', 'DISPID_SRRAudio', 'SP_VISEME_2',
    'SPDKL_LocalMachine', 'SITooLoud', 'SPPS_SuppressWord',
    'SPPHRASERULE', 'DISPID_SAFType', 'SVP_9', 'SP_VISEME_15',
    'DISPID_SLWs_NewEnum', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRProfile', 'DISPID_SAFSetWaveFormatEx',
    'ISpGrammarBuilder', 'SP_VISEME_1', 'DISPID_SWFESamplesPerSec',
    'SpeechAudioFormatGUIDText', 'SPEI_SOUND_START',
    'DISPID_SABIMinNotification', 'ISpeechPhraseRules',
    'eLEXTYPE_USER_SHORTCUT', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpRecoGrammar2',
    'DISPID_SLWLangId', 'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPANumberOfElementsInResult',
    'ISpPhoneticAlphabetConverter', 'SpeechStreamFileMode',
    'DISPID_SRRDiscardResultInfo', 'SREStreamEnd', 'SP_VISEME_19',
    'DISPID_SOTsItem', 'DISPID_SpeechRecoResultTimes', 'SPVISEMES',
    'SpeechPropertyResourceUsage', 'SPEVENT', 'SDTProperty',
    'SpMMAudioEnum', 'eLEXTYPE_VENDORLEXICON',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SOTCreateInstance',
    'SDTLexicalForm', 'ISpeechPhraseInfo',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechRecoGrammar',
    'SPVPRIORITY', 'ISpeechRecognizer',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVEWord',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRGRecoContext',
    'DISPID_SLWType', 'SPCS_DISABLED', 'ISpeechAudioFormat',
    'SPEI_TTS_PRIVATE', 'DISPID_SBSRead', 'ISpeechResourceLoader',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRSSupportedLanguages', 'SPPHRASEREPLACEMENT',
    'DISPID_SPRuleParent', 'DISPID_SPIProperties', 'ISpRecognizer',
    '_SPAUDIOSTATE', 'SpeechRecognizerState', 'DISPID_SPEsCount',
    'SAFT32kHz8BitMono', 'DISPID_SVSInputWordLength',
    'ISpeechPhraseAlternates', 'DISPID_SPIStartTime',
    'DISPID_SPAsItem', 'SpShortcut', 'SPSEMANTICERRORINFO',
    'DISPID_SABIEventBias', 'SpFileStream', 'DISPID_SPRs_NewEnum',
    'eLEXTYPE_PRIVATE1'
]
